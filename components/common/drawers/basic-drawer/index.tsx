...
const BasicDrawer: FunctionComponent<PropsWithChildren<Props>> = ({
	placement,
	children,
	header,
	onClose,
	...
	return (
		<>
			...
			<div
				className={clsx(
					"bg-emerald-900 transition-transform ease-in duration-200 fixed z-[999] inset-y-0",
					{
						"w-full sm:w-[450px]":
			...
			>
				<div className="shadow-lg py-4 pl-7 pr-3 flex justify-between">
					...
					<button onClick={() => onClose()} className="icon-button">
						<CloseIcon className="size-4 [&>path]:fill-white" />
					</button>
				</div>
				{children}
			</div>

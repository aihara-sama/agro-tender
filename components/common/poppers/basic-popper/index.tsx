...
const BasicPopper: ForwardRefRenderFunction<
	HTMLDivElement,
...
> = (
	...
	return (
		<div className={`relative ${className}`} ref={rootRef}>
			...
			<div
				id="actual-popper"
				className={`border overflow-auto bg-white max-h-[calc(100vh-70px)] shadow-md absolute right-0 rounded-[3px] z-[999] transition-fade duration-200 ease-in-out ${clsx(
					{
...
export default forwardRef(BasicPopper);
